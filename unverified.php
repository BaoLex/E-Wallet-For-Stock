...
<h2>View unverified users. Hover images to zoom in</h2>
...
<?php
$count=1;
$sel_query="Select * from users WHERE Status = 'unverified' or Status = 'info_request' ORDER BY ID desc;";
...
{ ?>
	...
	<td align="center">
	<a href="additional_info.php?id=<?php echo $row["Id"]; ?>">Request Additional Info</a>
	</td>
